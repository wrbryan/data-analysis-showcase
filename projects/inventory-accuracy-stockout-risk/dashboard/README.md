...
* KPI cards: historical stockout-observation rate, current Critical+High
  ...
  `kpi_summary.csv`.
* Show the distinction between historical observations (70.29% in this
  synthetic run) and current latest action records (2,027 / 56.31%).
...
* Keep the exact tier order and definitions visible: Critical, High, Watch,
  Routine. The report itself contains only Critical and High.
